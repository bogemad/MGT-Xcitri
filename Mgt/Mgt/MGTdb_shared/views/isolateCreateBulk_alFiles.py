...
from .FuncsAuxAndDb import routeToRightRawQFn as routeToRightFn
...
def page(request, pk, org):
	...
	(list_serverStatus, list_assignStatus, list_privStatus, boolChoices) = routeToRightFn.isolateChoices(org)

	return render(request, 'Templates/isolateCreateBulk_alFiles.html', {"project": proj, "isolates": isolates, "IsoColNames": IsolColNames, "serverStatus": list_serverStatus, "assignStatus": list_assignStatus, "privStatus": list_privStatus, 'boolChoices': boolChoices, 'organism': org })
