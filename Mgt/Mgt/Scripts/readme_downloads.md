...
```sh
python3 createDump_PuAllelicProf.py --mgtBasePath ../ --settingFn Mgt.settings_local_sk > outfile
```
...
```sh
python3 createDump_ProjAllelicProf.py --mgtBasePath ../ --settingFn Mgt.settings_local_sk > outfile
```
